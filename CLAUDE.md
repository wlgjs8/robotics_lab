...
J3/elbow is fixed to the Rainbow/URDF range `[-150 deg, +150 deg]` in
tracked safety limits, the joint-limit barrier, IK, examples, and runbooks.
Never restore a wider site margin or widen the URDF to hide an unreachable
Cartesian target.

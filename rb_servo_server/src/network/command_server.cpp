...
// stop motion or adjust the safety floor / ROI box / user floor plane while another
// client (e.g. policy_runner) holds the command lease. SetSafetyFloorZ is bounded server-side

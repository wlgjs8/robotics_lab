...
def main(argv=None):
    ...
    parser.add_argument("--rest-n", type=float, default=10.0, help="force_gate.rest_force_n")
    parser.add_argument("--peak-n", type=float, default=12.0, help="force_gate.peak_force_n")
    parser.add_argument("--b", type=float, default=500.0, help="derived damping (peak-rest)/peak_vel [N*s/m]")
    parser.add_argument("--v-cross-mm-s", type=float, default=4.0, help="force_gate.peak_vel_mm_s")

...
COLUMNS = [
    ...
    ("udp_command_count", "udp_command_count"),
    ...
    ("async_commands_enqueued_total", "async_commands_enqueued_total"),
    ("async_commands_sent_total", "async_commands_sent_total"),
    ("async_commands_acked_total", "async_commands_acked_total"),
    ("official_tracking_window_sec", "official_tracking_window_sec"),
    ("measured_worker_window_sec", "measured_worker_window_sec"),
    ("official_servo_rate_hz", "official_servo_rate_hz"),
    ("expected_servo_ticks", "expected_servo_ticks"),
    ("goal_window_commands_sent", "goal_window_commands_sent"),
    ("goal_window_commands_acked", "goal_window_commands_acked"),
    ("ack_coverage_ratio", "ack_coverage_ratio"),
    ("effective_goal_command_rate_hz", "effective_goal_command_rate_hz"),
    ("worker_send_rate_hz", "worker_send_rate_hz"),
    ("worker_lifetime_send_rate_hz", "worker_lifetime_send_rate_hz"),
    ("worker_sends_outside_official_window", "worker_sends_outside_official_window"),
...
def async_report_fields(summary: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "udp_command_count": first_number(summary, "udp_command_count"),
        "server_servo_tick_count": first_number(summary, "server_servo_tick_count"),
        "async_commands_enqueued_total": async_number(
            summary,
            "async_commands_enqueued_total",
            "commands_enqueued_total",
        ),
        "async_commands_sent_total": async_number(
            summary,
            "async_commands_sent_total",
            "commands_sent_total",
        ),
        "async_commands_acked_total": async_number(
            summary,
            "async_commands_acked_total",
            "commands_acked_total",
        ),
        "official_tracking_window_sec": first_number(summary, "official_tracking_window_sec"),
        "measured_worker_window_sec": first_number(summary, "measured_worker_window_sec", "worker_active_window_sec"),
        "official_servo_rate_hz": first_number(summary, "official_servo_rate_hz", "servo_rate_hz"),
        "expected_servo_ticks": first_number(summary, "expected_servo_ticks"),
        "goal_window_commands_sent": async_number(summary, "goal_window_commands_sent"),
        "goal_window_commands_acked": async_number(summary, "goal_window_commands_acked"),
        "ack_coverage_ratio": first_number(summary, "ack_coverage_ratio"),
        "effective_goal_command_rate_hz": first_number(summary, "effective_goal_command_rate_hz"),
        "worker_send_rate_hz": first_number(summary, "worker_send_rate_hz"),
        "worker_lifetime_send_rate_hz": first_number(summary, "worker_lifetime_send_rate_hz"),
        "worker_sends_outside_official_window": first_number(summary, "worker_sends_outside_official_window"),

...
def row_from_summary(summary: dict[str, Any], exp: dict[str, Any], meta: dict[str, Any]) -> dict[str, Any]:
    ...
    row = {
        ...
        "udp_command_count": summary.get("udp_command_count"),
        "server_servo_tick_count": summary.get("server_servo_tick_count"),
        "async_commands_enqueued_total": first_present(
            summary.get("async_commands_enqueued_total"),
            summary.get("commands_enqueued_total"),
        ),
        "async_commands_sent_total": first_present(
            summary.get("async_commands_sent_total"),
            summary.get("commands_sent_total"),
        ),
        "async_commands_acked_total": first_present(
            summary.get("async_commands_acked_total"),
            summary.get("commands_acked_total"),
        ),
        "official_tracking_window_sec": summary.get("official_tracking_window_sec"),
        "measured_worker_window_sec": first_present(
            summary.get("measured_worker_window_sec"),
            summary.get("worker_active_window_sec"),
        ),
        "official_servo_rate_hz": first_present(summary.get("official_servo_rate_hz"), summary.get("servo_rate_hz")),
        "expected_servo_ticks": summary.get("expected_servo_ticks"),
        "goal_window_commands_sent": summary.get("goal_window_commands_sent"),
        "goal_window_commands_acked": summary.get("goal_window_commands_acked"),
        "ack_coverage_ratio": summary.get("ack_coverage_ratio"),
        "effective_goal_command_rate_hz": summary.get("effective_goal_command_rate_hz"),
        "worker_send_rate_hz": summary.get("worker_send_rate_hz"),
        "worker_lifetime_send_rate_hz": summary.get("worker_lifetime_send_rate_hz"),
        "worker_sends_outside_official_window": summary.get("worker_sends_outside_official_window"),

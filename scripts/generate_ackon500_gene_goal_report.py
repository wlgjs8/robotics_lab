...
def repeatability_row(candidate: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "physical_readiness_status": "blocked",
...
def build_repeatability_summary(candidates: list[dict[str, Any]], artifact_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "optional_dual_sequential_row_count": len(optional_dual_rows),
        "dual_sequential_policy": "optional_controller_simulation_only_not_counted_for_left_right_global_pass",
...
def repeatability_markdown(summary: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "Optional dual sequential rows, if present, are controller-simulation only and are not counted toward left/right aggregate pass.",
            "",
            "## Physical Readiness",
            "",
            ...
            "",
            f"Policy: `{summary.get('dual_sequential_policy')}`",
            "",
...
def report_markdown(summary: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        "",
        "This is rbpodo controller pgmode-simulation evidence only. Physical robot motion is not approved.",
        "The diagnostics_suspect caveat remains visible; repeatability does not retire it.",
        "",
...
def timing_markdown(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"physical_readiness.status: `{summary['physical_readiness']['status']}`",
            "",
            "The diagnostics_suspect caveat remains visible; timing evidence does not retire it.",
            "",
            table(
...
def error_markdown(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"physical_readiness.status: `{summary['physical_readiness']['status']}`",
            "",
            "The diagnostics_suspect caveat remains visible; error decomposition evidence does not retire it.",
            "",
            table(
                summary.get("candidates", []),
                [

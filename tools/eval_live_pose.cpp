...
int main(int argc, char** argv) {
    ...
    // The whole pika mesh set (raw and hull) lives under rb5_850e as of 2026-09-02 --
    // one physical gripper, one directory. This tool needs both variants, because its
    // raw mode exists precisely to drive a non-convex mesh through the convexity guard.

...
from rb_servo_gui.app import _joint_cfg_radians, _joint_marker_position, _mount_position, _pose6_from_mounts, _pose_wxyz, update_scene_markers
...
class GuiContractsTest(unittest.TestCase):
    ...
    def test_tcp_pose_target_packet_uses_gizmo_pose_and_holds_other_arm(self):
        _, client, safety = self.make_safety(sample_state())
    ...
    def test_visual_disabled_state_matches_safety_blocks(self):
        ...
        self.assertFalse(mock_states["tcp_pose"])

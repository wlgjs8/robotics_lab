...
- Normalization: train-only, samples=27966

## Leaderboard

| Rank | Model | Split | Family | Backbone | Train Norm MSE | Norm MSE | Action MSE | Trans End | Rot End | Grip MSE | P50 Lat ms | Checkpoint |
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | direct_bc_dinov3_convnext_tiny | session_holdout | direct_bc_chunk | dinov3_convnext_tiny | 0.513364 | 0.672899 | 0.876685 | 0.00168858 | 0.00682673 | 6.13671 | 3.431 | `a1ac7d646d9cb9417ceade8e34c3cab96669d843bad4b99ddc341949918caef3` |
